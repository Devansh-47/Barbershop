...
public class Owner {
    String shop_profile_pic,shop_name,owner_name,shop_mail,shop_password,shop_mobile_no;

    public Owner(String shop_profile_pic, String shop_name, String owner_name, String shop_mail, String shop_password, String shop_mobile_no) {
